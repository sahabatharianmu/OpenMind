...
// PaymentTransactionResponse represents a payment transaction in a list
...
// PaginatedPaymentTransactionResponse represents a paginated list of transactions
...
// QRISDataResponse represents the stored QR data for a pending transaction
type QRISDataResponse struct {
	ID                 uuid.UUID  `json:"id"`
	TransactionID      string     `json:"transaction_id"`
